/**
 * CarbonWise — Input Validation Middleware
 *
 * Reusable validation middleware powered by express-validator.
 * Provides centralized error formatting and common validation chains.
 */

const { validationResult, body, param, query } = require('express-validator');

/**
 * Middleware that checks for validation errors from preceding validation chains.
 * Returns a 400 response with formatted errors if any are found.
 */
...
/**
 * Pre-built validation chains for common fields.
 * Use these in route definitions to keep validation DRY.
 */
const validators = {
  // Auth validators
  email: body('email')
