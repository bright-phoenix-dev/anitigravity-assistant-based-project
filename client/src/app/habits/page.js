      ...
      <div className="glass-card habits-create-section">
        ...
        {showForm && (
          <form onSubmit={handleSubmit} className="habit-form animate-slide-in-up">
            ...
            <button aria-label="Interactive button" type="submit" className="btn-primary" disabled={submitting || !form.name}>
          ...
          <div className="habits-list">
            {inactiveHabits.map(h => (
              <div key={h.id} className="habit-card habit-inactive">
                ...
                <div className="habit-actions">
                  <button aria-label="Interactive button" className="btn-secondary" onClick={() => handleToggle(h)}>
                    ▶️ Resume
                  </button>
                  <button aria-label="Interactive button" className="btn-ghost habit-delete-btn" onClick={() => handleDelete(h)}>
                    🗑️
                  </button>
                </div>
              </div>
